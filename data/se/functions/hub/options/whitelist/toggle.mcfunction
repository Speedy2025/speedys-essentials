...
execute store result score #hub.whitelisted se.storage run data get storage rx:io playerdb.player.data.se.hub.whitelisted

#Flip States
execute if score #hub.whitelisted se.storage matches 0 run data modify storage rx:io playerdb.player.data.se.hub.whitelisted set value 1b
...
execute if score #hub.whitelisted se.storage matches 1 run data modify storage rx:io playerdb.player.data.se.hub.whitelisted set value 0b
