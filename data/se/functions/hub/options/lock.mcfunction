...
execute store result score #hub.locked se.storage run data get storage rx:io playerdb.player.data.se.hub.locked

#Flip States
execute if score #hub.locked se.storage matches 0 run data modify storage rx:io playerdb.player.data.se.hub.locked set value 1b
...
execute if score #hub.locked se.storage matches 1 run data modify storage rx:io playerdb.player.data.se.hub.locked set value 0b
