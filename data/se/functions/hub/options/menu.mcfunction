...
# <X>
execute store result score #se.hub.output.x1 se.storage run data get storage rx:io playerdb.player.data.se.hub.x 100.00
execute store result score #se.hub.output.x2 se.storage run data get storage rx:io playerdb.player.data.se.hub.x 1
...
# <Y>
execute store result score #se.hub.output.y1 se.storage run data get storage rx:io playerdb.player.data.se.hub.y 100
execute store result score #se.hub.output.y2 se.storage run data get storage rx:io playerdb.player.data.se.hub.y 1
...
# <Z>
execute store result score #se.hub.output.z1 se.storage run data get storage rx:io playerdb.player.data.se.hub.z 100
execute store result score #se.hub.output.z2 se.storage run data get storage rx:io playerdb.player.data.se.hub.z 1
...
#Header
execute unless data storage rx:io playerdb.player.data.se.hub.name run tellraw @s ["",{"text":"\u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020","color":"blue","strikethrough":true},{"text":" [Your Hub] ","color":"green"},{"text":"\u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020","color":"blue","strikethrough":true}]
execute if data storage rx:io playerdb.player.data.se.hub.name run tellraw @s ["",{"text":"\u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 ","color":"blue","strikethrough":true},{"text":" [","color":"green"},{"nbt":"playerdb.player.data.se.hub.name","interpret":true,"storage":"rx:io","color":"green"},{"text":"] ","color":"green"},{"text":" \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020 \u0020","color":"blue","strikethrough":true}]
...
tellraw @s ["",{"text":"Dimension ID: ","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Your Hub's Dimension ID","color":"gold"},{"text":"\nYou can set your hub to your current location using the "},{"text":"[Set hub]","color":"dark_aqua"},{"text":" button just above and to the right."}]}},{"nbt":"playerdb.player.data.se.hub.dimName","storage":"rx:io"}]
