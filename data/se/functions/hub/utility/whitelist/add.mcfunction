...
execute if score #hub.whitelisted se.internal matches 0 store result storage rx.playerdb:io player.data.se.hub.whitelisttemp int 1 run scoreboard players get @s hub
execute if score #hub.whitelisted se.internal matches 0 run data modify storage rx.playerdb:io player.data.se.hub.whitelist prepend from storage rx.playerdb:io player.data.se.hub.whitelisttemp
