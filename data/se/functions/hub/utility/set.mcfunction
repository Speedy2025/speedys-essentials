...
execute store result storage rx:io playerdb.player.data.se.hub.rx int 1 run data get entity @s Rotation[0] 100
execute store result storage rx:io playerdb.player.data.se.hub.rz int 1 run data get entity @s Rotation[1] 100
