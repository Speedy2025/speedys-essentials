...
#Calls se:dimswap
execute store result entity @s Pos[0] int 1 run data get storage rx:io playerdb.player.data.se.hub.x
execute store result entity @s Pos[1] int 1 run data get storage rx:io playerdb.player.data.se.hub.y
execute store result entity @s Pos[2] int 1 run data get storage rx:io playerdb.player.data.se.hub.z
