...
scoreboard players operation $in.uid rx.pdb.io = @s hub
function #rx.playerdb:api/v2/get

execute store result score #se.hub.valid se.storage run data get storage rx.playerdb:io player.data.se.hub
