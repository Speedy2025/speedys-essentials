...
execute if score #hub.exist se.internal matches 1.. if score @s rx.uid = @s hub run function se:hub/teleport/step
execute if score #hub.exist se.internal matches 1.. unless score @s rx.uid = @s hub if entity @s[tag=se.bypass] run function se:hub/teleport/step