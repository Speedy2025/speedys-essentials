...
#Calls se:dimswap
say Ping
execute store result entity @s Pos[0] double 1 run data get storage rx:io playerdb.player.data.se.homes[0].x
execute store result entity @s Pos[1] double 1 run data get storage rx:io playerdb.player.data.se.homes[0].y
execute store result entity @s Pos[2] double 1 run data get storage rx:io playerdb.player.data.se.homes[0].z
