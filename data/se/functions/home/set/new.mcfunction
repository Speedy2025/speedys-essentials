...
execute store result storage rx:io playerdb.player.data.se.homes[{id: -1}].rx int 1 run data get entity @s Rotation[0] 100
execute store result storage rx:io playerdb.player.data.se.homes[{id: -1}].rz int 1 run data get entity @s Rotation[1] 100
