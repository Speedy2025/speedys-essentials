...
execute store result storage rx:io playerdb.player.data.se.homes[0].rx int 1 run data get entity @s Rotation[0] 1
execute store result storage rx:io playerdb.player.data.se.homes[0].rz int 1 run data get entity @s Rotation[1] 1
