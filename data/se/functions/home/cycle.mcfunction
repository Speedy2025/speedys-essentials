...
execute store result score #cycle.length se.internal run data get storage rx:io playerdb.player.data.se.homes
execute store result score #cycle.id se.internal run data get storage rx:io playerdb.player.data.se.homes[0].id
