...
#      Note: I can only be certain of this because each function ALWAYS calls rx.playerdb:api/get or .../get_self
...
execute if data storage rx:io playerdb.player.data.se.homes[-1].name run tellraw @s ["",{"nbt":"playerdb.player.data.se.homes[-1].id","storage":"rx:io"},{"text":" - "},{"nbt":"playerdb.player.data.se.homes[-1].name","color":"gold","interpret":true,"storage":"rx:io","hoverEvent":{"action":"show_text","contents":["",{"text":"Coords: "},{"score":{"name":"#se.homes.x2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.x1","objective":"se.storage"},"color":"gold"},{"text":" "},{"score":{"name":"#se.homes.y2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.y1","objective":"se.storage"},"color":"gold"},{"text":" "},{"score":{"name":"#se.homes.z2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.z1","objective":"se.storage"},"color":"gold"},{"text":"\nDimension: "},{"nbt":"playerdb.player.data.se.homes[-1].dimName","storage":"rx:io","color":"gold"}]}}]
execute unless data storage rx:io playerdb.player.data.se.homes[-1].name run tellraw @s ["",{"nbt":"playerdb.player.data.se.homes[-1].id","storage":"rx:io"},{"text":" - "},{"score":{"name":"#se.homes.x2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.x1","objective":"se.storage"},"color":"gold"},{"text":" "},{"score":{"name":"#se.homes.y2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.y1","objective":"se.storage"},"color":"gold"},{"text":" "},{"score":{"name":"#se.homes.z2","objective":"se.storage"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#se.homes.z1","objective":"se.storage"},"color":"gold"},{"text":" in "},{"nbt":"playerdb.player.data.se.homes[-1].dimName","storage":"rx:io","color":"gold"}]

#> Clean up info.
data remove storage rx:io playerdb.player.data.se.homes[-1]
